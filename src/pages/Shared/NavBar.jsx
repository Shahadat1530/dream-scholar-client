...
const NavBar = () => {
    ...
    const links = (
        <>
            ...
            {user && user.email && (
                <>
                    {/* Both Admins & Moderators see Admin Dashboard */}
                    {isAdmin || isModerator ? (
    ...
    return (
        <div className="navbar bg-base-100 shadow-md">
            <div className="navbar-start">
                <NavLink to="/" className="btn btn-ghost text-xl font-bold">Dream Scholar Hub</NavLink>
            </div>
            ...
            <div className="navbar-end">
                {user && user.email ? (
                    ...
                    <>
                        <NavLink to="/login" className="bg-gradient-to-r from-pink-500 to-yellow-500 text-white font-semibold py-2 px-4 rounded-md mr-2">
                            Login
                        </NavLink>
